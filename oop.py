...
if __name__ == '__main__':
    ...
    cv2.createTrackbar("LH", "Screen", 0, 200, lambda x: trackbar_change("LH", x))
    cv2.createTrackbar("LS", "Screen", 0, 200, lambda x: trackbar_change("LS", x))
    cv2.createTrackbar("LV", "Screen", 0, 200, lambda x: trackbar_change("LV", x))

    cv2.createTrackbar("HH", "Screen", 200, 200, lambda x: trackbar_change("HH", x))
    cv2.createTrackbar("HS", "Screen", 200, 200, lambda x: trackbar_change("HS", x))
    cv2.createTrackbar("HV", "Screen", 200, 200, lambda x: trackbar_change("HV", x))

    cv2.createTrackbar("Threshold", "Screen", 200, 200, lambda x: trackbar_change("Threshold", x))
    ...
    while True:
        ...
        cv2.imshow("Screen", Frame_Grab.combine_regions(r1_frame, r2_frame, r3_frame))
